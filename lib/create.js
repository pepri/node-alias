...
module.exports = exports = function (targetPath, volumeName, volumePath) {
  ...
  var parentStat = fs.statSync(parentPath);
  var volumePath = process.platform === 'darwin'
    ? findVolume(targetPath, targetStat)
    : (typeof volumePath === 'undefined' ? path.resolve('.') : String(volumePath));
  ...
  info.volume = {
    name: typeof volumeName === 'undefined' ? addon.getVolumeName(volumePath) : String(volumeName),
